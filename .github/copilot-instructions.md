...
- Always run `php artisan make:migration` when need to create new migration files.
...
- When create new migrations, ensure they have softDeletes if the table requires it.
