...
class PlanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.admin.plans.list', compact('plans'));
    }
    ...
    {
        return view('user.admin.plans.create');
    }
    ...
    public function fetchData(Request $request)
    {
        if ($request->ajax()) {
            ...
            return response()->json(['data' => view('user.admin.plans.table', compact('plans'))->render()]);
        }
    }
}
