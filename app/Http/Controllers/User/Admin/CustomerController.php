...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        $customers = User::Role('MEMBER_SOVEREIGN')->orderBy(DB::raw('CONCAT(first_name, " ", middle_name, " ", last_name)'))->paginate(15);
        return view('user.admin.customer.list')->with(compact('customers'));
    }
    ...
    {
        return view('user.admin.customer.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        $data->assignRole('MEMBER_SOVEREIGN');
        $maildata = [
