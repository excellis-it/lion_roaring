...
class OrganizationCenterController extends Controller
{
    ...
    public function index()
    {
        if (auth()->user()->can('Manage Organization Center')) {
            ...
            return view('user.admin.organization-centers.list')->with(compact('organization_centers'));
        } else {
    ...
    public function fetchData(Request $request)
    {
        if ($request->ajax()) {
            ...
            return response()->json(['data' => view('user.admin.organization-centers.table', compact('organization_centers'))->render()]);
        }
    }
    ...
    public function create()
    {
        if (auth()->user()->can('Create Organization Center')) {
            ...
            return view('user.admin.organization-centers.create')->with(compact('organizations'));
        } else {
            abort(403, 'You do not have permission to access this page.');
        }
    }
