...
class ElearningCategoryController extends Controller
{
    ...
    public function fetchData(Request $request)
    {
        if ($request->ajax()) {
            ...
            $categories = ElearningCategory::query()
            ...
            return response()->json(['data' => view('user.elearning-category.table', compact('categories'))->render()]);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('elearning-categories.index')->with('message', 'Category created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        if (auth()->user()->can('Edit Elearning Category')) {
            ...
            return redirect()->route('elearning-categories.index')->with('message', 'Category updated successfully.');
        } else {
            abort(403, 'You do not have permission to access this page.');
        }
    }
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('elearning-categories.index')->with('message', 'Category deleted successfully.');
    }
}
