...
@section('title')
    E-learning Newsletter List - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3">
                                <div class="col-md-10">
                                    <h3 class="mb-3">E-learning Newsletter List</h3>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle bg-white color_body_text">
                                    ...
                                    <tbody id="newsletters_tbody">
                                        @include('user.elearning-newsletter.table', [
    ...
    <script>
        ...
        $(function() {
            ...
            $('#sendEmailForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('user.elearning.newsletters.send-mail') }}",
                    method: 'POST',
                    data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query, topic_id, per_page) {
                $.ajax({
                    url: "{{ route('user.elearning.newsletters.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
