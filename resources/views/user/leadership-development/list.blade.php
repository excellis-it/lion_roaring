                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-2 float-right">
                                        @if (auth()->user()->can('Upload Leadership Development'))
                                            <a href="{{ route('leadership-development.upload') }}" class="btn btn-primary w-100"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle bg-white color_body_text">
                                        ...
                                        <tbody>
                                            @include('user.leadership-development.table', ['files' => $files])
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('leadership-development.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
