...
@section('title')
    E-learning Category List - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle bg-white color_body_text">
                                        ...
                                        <tbody>
                                            @include('user.elearning-category.table', [
...
@push('scripts')
    <script>
        $(document).on('click', '#delete', function(e) {
            swal({
                    title: "Are you sure?",
                    text: "To remove this category from the category board",
                    type: "warning",
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('elearning-categories.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
