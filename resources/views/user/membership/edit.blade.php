                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" id="amount_cost_wrap">
                        <div class="box_label">
                            ...
                            <input name="monthly_cost" class="form-control"
                                value="{{ old('monthly_cost', $tier->monthly_cost) }}" type="number" step="0.01"
                                min="0">
                            @error('monthly_cost')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-6 mb-3" id="yearly_cost_wrap">
                        <div class="box_label">
                            ...
                            <input name="yearly_cost" class="form-control"
                                value="{{ old('yearly_cost', $tier->yearly_cost) }}" type="number" step="0.01"
                                min="0">
                            @error('yearly_cost')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
