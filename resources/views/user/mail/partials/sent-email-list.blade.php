...
<div class="emailRow">
    ...
    <h3 class="emailRow__title view-mail" data-route="{{ route('mail.sent.view', base64_encode(!empty($mail->reply_of) ? $mail->reply_of : $mail->id)) }}">
        {{ $mail->user->full_name ?? '' }}
    </h3>

    <div class="emailRow__message view-mail" data-route="{{ route('mail.sent.view', base64_encode(!empty($mail->reply_of) ? $mail->reply_of : $mail->id)) }}">
        <h4>
            {{ $mail->subject }}
