...
<div class="emailRow">
    ...
    <h3 class="emailRow__title view-mail" data-route="{{ route('mail.sent.view', base64_encode($mail->id)) }}">
        {{ $mail->user->full_name ?? '' }}
    </h3>
    ...
    <p class="emailRow__time view-mail" data-route="{{ route('mail.sent.view', base64_encode($mail->id)) }}">
