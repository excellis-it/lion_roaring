                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="product_category_subtitle" id="product_category_subtitle" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="featured_product_title" id="featured_product_title" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="featured_product_subtitle" id="featured_product_subtitle" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="new_product_title" id="new_product_title" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="new_product_subtitle" id="new_product_subtitle" class="form-control"
