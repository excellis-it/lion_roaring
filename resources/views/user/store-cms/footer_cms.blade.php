...
@section('content')
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('user.store-cms.footer.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_facebook_link" id="footer_facebook_link" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_twitter_link" id="footer_twitter_link" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_instagram_link" id="footer_instagram_link" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_youtube_link" id="footer_youtube_link" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_address_title" id="footer_address_title" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_phone_number" id="footer_phone_number" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_newsletter_title" id="footer_newsletter_title" class="form-control"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="footer_copywrite_text" id="footer_copywrite_text" class="form-control"
                            ...
                            <div class="w-100 text-end d-flex align-items-center justify-content-end mt-3">
                                ...
                                <a href="{{ route('user.store-cms.list') }}" class="print_btn print_btn_vv"
                                >Cancel</a>
                            </div>
                        </div>
                </div>
