                    ...
                    <table width="600" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td align="center" style="padding:20px; background-color:#7851a9;">
                                <img src="{{ Helper::estoreHeaderLogoUrl() }}" alt="{{ config('app.name') }}"
                        ...
                        <tr>
                            <td style="padding:0 20px 20px 20px;">
                                <table width="100%" cellpadding="5" cellspacing="0"
                                    style="border-collapse:collapse; border:1px solid #ccc; font-size:13px;">
                                        ...
                                        <td style="width:40%;">
                                            <table width="100%" cellpadding="5" cellspacing="0"
                                                ...
                                                @if (!empty($order->promo_discount) && $order->promo_discount > 0)
                                                    <tr>
                                                        <td align="right" style="font-weight:bold;">PROMO DISCOUNT:
                                                        </td>
                                                        <td align="right">-
                                                            ${{ number_format($order->promo_discount, 2) }}</td>
                                                    </tr>
                                                @endif
                                                ...
                                                @if (!empty($order->tax_amount) && $order->tax_amount > 0)
                                                    <tr>
                                                        ...
                                                        <td align="right">${{ number_format($order->tax_amount, 2) }}
                                                        </td>
                                                    </tr>
                                                @endif
                                                ...
                                                @if (!empty($order->handling_amount) && $order->handling_amount > 0)
                                                    <tr>
                                                        <td align="right" style="font-weight:bold;">HANDLING:</td>
                                                        <td align="right">
                                                            ${{ number_format($order->handling_amount, 2) }}</td>
                                                    </tr>
                                                @endif

                                                @if (!empty($order->credit_card_fee) && $order->credit_card_fee > 0)
                                                    <tr>
                                                        <td align="right" style="font-weight:bold;">CREDIT CARD FEE:
                                                        </td>
                                                        <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">${{ number_format($order->total_amount, 2) }}
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td
                                style="padding:20px; background:#f4f4f4; text-align:center; font-size:12px; color:#888;">
