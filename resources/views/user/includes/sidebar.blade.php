    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="menu_bb">
                                ...
                                <a href="{{ route('user.page', ['name' => 'Mail', 'permission' => 'Manage Email']) }}">
                                    <span>
                ...
                @if (Gate::check('Manage Education'))
                    <li class="sidebar-item">
                        ...
                        <div class="collapse" id="collapseExampleEducation">
                            <div class="menu_bb">
                                <a href="{{ route('user.page', ['name' => 'Becoming Sovereign', 'permission' => 'Manage Education']) }}">
                                    <span>
                                ...
                                <a href="{{ route('user.page', ['name' => 'Becoming Christ Like', 'permission' => 'Manage Education']) }}">
                                    <span>
                                ...
                                <a href="{{ route('user.page', ['name' => 'Leadership Development', 'permission' => 'Manage Education']) }}">
                                    <span>
                                ...
                                <a href="{{ route('user.page', ['name' => 'Lion Roaring Store', 'permission' => 'Manage Education']) }}">
                                    <span>
                                        <img src="{{ asset('user_assets/images/Shared Folders.png') }}" alt="">
                                    </span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="#" aria-expanded="false" data-bs-toggle="collapse" data-bs-target="#collapseExample4">
                        <span>
                    ...
                    <div class="collapse" id="collapseExample4">
                        <div class="menu_bb">
                            <a href="{{ route('user.page', ['name' => 'Job Posting', 'permission' => 'Manage Bulletin']) }}">
                                <span>
                                    <img src="{{ asset('user_assets/images/Job Posting.png') }}" alt="">
                                </span>
                                <span>Job Posting</span>
                            </a>
                            <a href="{{ route('user.page', ['name' => 'Meeting Schedule', 'permission' => 'Manage Bulletin']) }}">
                                <span>
                            ...
                            <a href="{{ route('user.page', ['name' => 'Live Events', 'permission' => 'Manage Bulletin']) }}">
                                <span>
                                    <img src="{{ asset('user_assets/images/Live Events.png') }}" alt="">
                                </span>
                                <span>Live Events</span>
