                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="mb-4">
                                    ...
                                    <p><strong>Country:</strong> {{ $partner->countries ? $partner->countries->name : 'N/A' }}</p>
                                    <p><strong>State:</strong> {{ $partner->states ? $partner->states->name : 'N/A' }}</p>
                                    <p><strong>City:</strong> {{ $partner->city ? $partner->city : 'N/A' }}</p>
                                    <p><strong>Address:</strong> {{ $partner->address ? $partner->address : 'N/A' }}</p>
                                    <p><strong>Address 2:</strong> {{ $partner->address2 ? $partner->address2 : 'N/A' }}</p>
