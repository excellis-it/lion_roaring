        ...
        <form>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <h3 class="mb-3 float-left">Dashboard</h3>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="ms-3">
                                            <a href="{{route('user.cms.list')}}" class="btn btn-primary">View All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="ms-3">
                                            <a href="{{route('user.newsletters.index')}}" class="btn btn-primary">View All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
