...
@section('title')
    Update Becoming Christ Like - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('becoming-christ-link.update', $file->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading_box mb-5">
                                    <h3>Update Becoming Christ Like</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="w-100 text-end d-flex align-items-center justify-content-end mt-3">
                                ...
                                <a href="{{ route('becoming-christ-link.index') . '?topic=' . ($new_topic ?? '') }}"
