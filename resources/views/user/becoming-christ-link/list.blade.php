...
@section('title')
Becoming Christ Like List - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <h3 class="mb-3">Becoming Christ Like List</h3>
                                    </div>
                                    <div class="col-md-2 float-right">
                                        @if (auth()->user()->can('Upload Becoming Christ Like'))
                                            <a href="{{ route('becoming-christ-link.upload') }}" class="btn btn-primary w-100"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle bg-white color_body_text">
                                        ...
                                        <tbody>
                                            @include('user.becoming-christ-link.table', ['files' => $files])
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('becoming-christ-link.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
