        ...
        <div
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                ...
                <tr style="background:#7851a9">
                    <td style="height:35px; color:#ffffff;height:36px;padding:0px 10px;font-size: 13px;">Item
                        Description
                    </td>
                    ...
                    <td style="color:#ffffff;height:36px;padding:0px 10px;font-size: 13px;text-align:center;">No. Of
                        Items
                    </td>
                    <td style="color:#ffffff;height:36px;padding:0px 10px;font-size: 13px;text-align:center;">Unit Price
                    </td>
                    <td style="color:#ffffff;height:36px;padding:0px 10px;font-size: 13px;text-align:center;">Net Price
                    </td>
                </tr>
                @php
                    $qty = 0;
                    ...
                    <td align="left" valign="top" style="width: 500px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            @if ($order->tax_amount > 0)
                                <tr>
                                    <td
                                        style="text-align:right;font-size:13px;font-weight:bold;color:#333; height:35px">
                                        TAX:</td>
                                    <td
                                        style="text-align: right;font-size:13px;border-bottom: 2px solid #eaeaea;color: #333; padding-right: 30px;">
