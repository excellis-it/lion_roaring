        ...
        <div
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                ...
                <tr style="background:#7851a9">
                    ...
                    <td style="height:36px;padding:0px 10px;font-size: 15px;color:#fff;text-align:center;">No. Of
                        Quantity</td>
                    <td style="height:36px;padding:0px 10px;font-size: 15px;color:#fff;text-align:right;">Unit Price
                    </td>
                ...
                @foreach ($order->orderItems as $item)
                    ...
                    <tr>
                        ...
                        <td
                            style="padding:0px 30px 0px 10px;text-align:right;color: #333; font-size: 13px;line-height:20px;">
                            $
                    ...
                    <td style="width:500px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            @if (!empty($order->promo_discount) && $order->promo_discount > 0)
                                <tr>
                                    <td
                                        style="text-align:right;font-size:15px;font-weight:bold;color:#333; height:35px;">
                                        PROMO DISCOUNT:</td>
                                    <td
                                        style="text-align:right;font-size:15px;border-bottom:2px solid #eaeaea;color:#333;padding-right:30px;">
