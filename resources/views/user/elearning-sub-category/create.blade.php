...
@section('title')
    E-learning Sub Category - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('elearning-sub-categories.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <select name="elearning_category_id" id="elearning_category_id" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('elearning_category_id') == $category->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control"
                                        value="{{ old('slug') }}" placeholder="Enter Sub Category Slug">
                                    @if ($errors->has('slug'))
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="file" name="image" id="image" class="form-control"
                                        value="{{ old('image') }}" placeholder="Enter Sub Category Image"
                                        accept="image/*">
                                    @if ($errors->has('image'))
