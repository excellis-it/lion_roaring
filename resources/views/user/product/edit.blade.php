                            ...
                            <div class="tab-pane fade show active" id="product-details" role="tabpanel"
                                ...
                                <div class="row align-items-center mb-5">
                                    ...
                                    <div class="col-xxl-3 col-md-6 mb-2">
                                        <div class="box_label">
                                            <label> Size Measurements Image</label>
                                            <p class="text-muted">Managed per category. To change this image, edit the
                                                category under <a
                                                    href="{{ route('categories.edit', $product->category_id) }}">Category
                                                    settings</a>.</p>
                                        </div>

                                        @if ($product->category && $product->category->size_measurements_image)
                                            <div class="mt-2">
                                                <img src="{{ Storage::url($product->category->size_measurements_image) }}"
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="box_label">
                                        ...
                                        <select name="feature_product" id="feature_product" class="form-control">
                                            ...
                                            <option value="1" {{ $product->feature_product == 1 ? 'selected' : '' }}>
                                                Yes
                                            </option>
                                            <option value="0" {{ $product->feature_product == 0 ? 'selected' : '' }}>
                                                No
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="box_label">
                                        ...
                                        <select name="is_new_product" id="is_new_product" class="form-control">
                                            ...
                                            <option value="1" {{ $product->is_new_product == 1 ? 'selected' : '' }}>
                                                Yes
                                            </option>
                                            <option value="0" {{ $product->is_new_product == 0 ? 'selected' : '' }}>
                                                No
                                            </option>
                                        </select>
                                ...
                                @if ($product->product_type == 'simple')
                                    <div class="col-md-12" id="simple-product-section">
                                        <div class="row">
                                                    ...
                                                    <select name="market_material_id" id="market_material_id"
                                                        ...
                                                        @foreach ($marketMaterials as $material)
                                                            <option value="{{ $material->id }}"
                                                                {{ old('market_material_id', $product->market_material_id) == $material->id ? 'selected' : '' }}>
                                                                {{ $material->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-3 mb-2 market-price-fields" style="display:none;">
                                                <div class="box_label">
                                                    ...
                                                    <input type="number" step="any" name="market_grams"
                                                        ...
                                                        value="{{ old('market_grams', $product->market_grams) }}"
                                                        min="0.01">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            <div class="box_label">
                                                ...
                                                <input type="text" name="other_charges[0][charge_name]"
                                                    class="form-control" placeholder="Ex. Package Charge">
                                                <span class="text-danger" id="other_charges.0.charge_name_error"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="box_label">
                                                ...
                                                <span class="text-danger" id="other_charges.0.charge_amount_error"></span>
                                            </div>
                                        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const useMarketCheckbox = document.getElementById('use_market_price');
            ...
            if (useMarketCheckbox) {
                useMarketCheckbox.addEventListener('change', togglePriceFields);
            }
            togglePriceFields();
