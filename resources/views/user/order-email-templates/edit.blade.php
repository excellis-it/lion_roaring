...
@section('title')
    Update Email Template - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form action="{{ route('order-email-templates.update', $template->id) }}" method="POST"
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="box_label">
                                    ...
                                    <textarea name="body" id="body" class="form-control" rows="8"
                                        placeholder="Use placeholders like {customer_name}, {order_id}, {order_list}, {total_order_value}">{{ old('body', $template->body) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="box_label">
                                    ...
                                    <select name="is_active" id="is_active" class="form-select">
                                        <option value="1"
                                            {{ old('is_active', $template->is_active) == 1 ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $template->is_active) == 0 ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                    @error('is_active')
                                        <span class="text-danger">{{ $message }}</span>
