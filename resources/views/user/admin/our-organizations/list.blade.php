...
@section('title')
    All Our Organization Details - {{ env('APP_NAME') }}
@endsection
@push('styles')
    <style>
        .dataTables_filter {
...
@section('create_button')
    @if (auth()->user()->can('Create Our Organization'))
        <a href="{{ route('user.admin.our-organizations.create') }}" class="btn btn-primary">+ Create New Our Organization</a>
    @endif
@endsection
@section('content')
    <section id="loading">
    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="table-responsive" id="our-organizations-data">
                <table class="table align-middle bg-white color_body_text" class="display">
                    ...
                    <tbody>
                        @include('user.admin.our-organizations.table')
...
@push('scripts')
    <script>
        $(document).on('click', '#delete', function(e) {
            swal({
                    title: "Are you sure?",
                    text: "To delete this Our Organization.",
                    type: "warning",
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('user.admin.our-organizations.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
