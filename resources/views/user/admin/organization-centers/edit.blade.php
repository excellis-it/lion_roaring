    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h3 class="mb-0">Edit Organization Center</h3>
                    <p class="text-muted small mb-0">Update organization center details</p>
                </div>
            </div>

            <form action="{{ route('user.admin.organization-centers.update', $organization_center->id) }}" method="post"
                            ...
                            <div class="form-group-div">
                                <div class="form-group">
                                    @if ($organization_center->banner_image)
                                        <img src="{{ Storage::url($organization_center->banner_image) }}"
                                            id="banner_image_preview" style="width: 180px; height: 100px;">
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group-div">
                                <div class="form-group">
                                    @if ($organization_center->image)
                                        <img src="{{ Storage::url($organization_center->image) }}" id="image_preview"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="btn-1">
                                ...
                                <a href="{{ route('user.admin.organization-centers.index') }}" class="print_btn print_btn_vv">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
