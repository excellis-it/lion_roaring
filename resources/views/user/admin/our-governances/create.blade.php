...
@section('title')
    {{ env('APP_NAME') }} | Create Our Governance Page
@endsection
@push('styles')
@endpush
    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h3 class="mb-0">Create Our Governance</h3>
                    <p class="text-muted small mb-0">Add a new governance structure</p>
                </div>
            </div>

            <form action="{{ route('user.admin.our-governances.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group-div">
                                <div class="form-group">
                                    <img src="" id="banner_image_preview"
                                        style="width: 250px; height: 80px; display:none;">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group-div">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="floatingInputValue" name="name"
                                        value="{{ old('name') }}" placeholder="Governance Name">
                                    @if ($errors->has('name'))
                                        <div class="error" style="color:red;">
