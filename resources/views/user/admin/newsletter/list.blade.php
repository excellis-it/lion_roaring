    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h3 class="mb-0">Newsletters List</h3>
                    <p class="text-muted small mb-0">View all newsletter subscriptions</p>
                </div>
            </div>
            ...
            <div class="table-responsive" id="newsletters-data">
                <table class="table align-middle bg-white color_body_text" class="display">
                    <thead class="color_head">
                        <tr class="header-row">
                            ...
                            <th class="sorting" data-sorting_type="asc" data-column_name="full_name" style="cursor: pointer"
                            ...
                            <th class="sorting" data-sorting_type="asc" data-column_name="message" style="cursor: pointer"
                                data-tippy-content="Sort by message"><span id="message_icon"></span>Message</th>
                                <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        @include('user.admin.newsletter.table')
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('user.admin.newsletters.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
