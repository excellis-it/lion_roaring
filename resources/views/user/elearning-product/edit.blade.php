...
@section('title')
    E-Learning Product Edit - {{ env('APP_NAME') }}
@endsection
@push('styles')
...
@section('content')
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('elearning.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading_box mb-5">
                                    <h3>E-Learning Product Details</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="w-100 text-end d-flex align-items-center justify-content-end mt-3">
                                ...
                                <a href="{{ route('elearning.index') }}" class="print_btn print_btn_vv">Cancel</a>
                            </div>
                        </div>
                </div>
            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $('#category_id').on('change', function() {
                ...
                var sub_category_id = "{{ $product->elearning_sub_category_id ?? '' }}";
                if (category_id) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $.each(response.data, function(key, value) {
                                var selected = (value.id == sub_category_id) ? 'selected' :
                                    '';
        ...
        <script>
            $(document).ready(function() {
                $('.remove-image').click(function() {
                    ...
                    $.ajax({
                        url: "{{ route('elearning.image.delete') }}",
                        type: 'GET',
                        data: {
                            "id": id,
                            "_token": token,
