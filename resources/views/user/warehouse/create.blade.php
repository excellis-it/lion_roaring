                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="email" name="contact_us_mail" id="contact_us_mail"
                                        ...
                                        placeholder="warehouse@example.com" value="{{ old('contact_us_mail') }}">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="box_label">
                                    ...
                                    <input type="number"  placeholder="Ex: 10.5" name="service_range" step="any"
                                    ...
                                    <select name="assign_user[]" id="assign_user"
                                        ...
                                        @foreach ($all_users as $user)
                                            <option value="{{ $user->id }}"
                                                ...
                                                {!! no_translate($user->full_name) !!} ({{ $user->email }})
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('assign_user')
    ...
    <script>
        $(document).ready(function() {
            ...
            function initMap() {
                ...
                const defaultLat = parseFloat($lat.val()) || 40.712776;
                const defaultLng = parseFloat($lng.val()) || -74.005974;
