...
<div class="container-fluid">
    <div class="bg_white_border">
        <div class="row mb-3 align-items-center">
            <div class="col-md-8">
                <h3 class="mb-0">Add Change Log Entry</h3>
            </div>
            <div class="col-md-4 text-end">
                <a href="{{ route('change-logs.index', ['platform' => $platform]) }}" class="btn btn-primary">Cancel</a>
            </div>
        </div>
        ...
        <form action="{{ route('change-logs.store') }}" method="POST" id="changeLogForm">
            @csrf
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select name="platform" class="form-control @error('platform') is-invalid @enderror" required>
                        <option value="web" @selected(old('platform', $platform) === 'web')>Web Version</option>
                        <option value="mobile" @selected(old('platform', $platform) === 'mobile')>Mobile App Version</option>
                    </select>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description" rows="10"
                        ...
                        translate="no">{{ old('description') }}</textarea>
