                ...
                <div class="modal-body">
                    ...
                    <div id="dropZone" class="drop-zone">
                        ...
                        <input type="file" id="fileInput" style="display: none" multiple
                            accept="image/*,.jpg,.jpeg,.jfif,.jpe,.png,.gif,.webp,.avif,.bmp,.tif,.tiff,.svg,.heic,.heif,image/heic,image/heif,image/jpeg,video/*,.mp4,.mkv,.avi,.mov,.wmv,.webm,.flv,.mpeg,.mpg,.m4v,.3gp,.ogv,.hevc,.ogg,application/pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt">
                    </div>
