                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-10">
                                        <h3 class="mb-3">Strategy List</h3>
                                    </div>
                                    <div class="col-md-2 float-right">
                                        @if (auth()->user()->can('Upload Strategy'))
                                            <a href="{{ route('strategy.upload') }}" class="btn btn-primary w-100"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle bg-white color_body_text">
                                        ...
                                        <tbody>
                                            @include('user.strategy.table', ['strategies' => $strategies])
