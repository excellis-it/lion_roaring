                                                    ...
                                                    <div class="login-username">
                                                        ...
                                                        <div class="input-group"
                                                            ...
                                                            <input type="text" name="lion_roaring_id_suffix"
                                                                ...
                                                                maxlength="4" placeholder="Enter last 4 digit ID/SSN"
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="login-username">
                                                        ...
                                                        @if (isset($lockedCountryId) && $lockedCountryId)
                                                            ...
                                                            <select name="country_display" id="country"
                                                            ...
                                                            <small class="text-muted"><i class="fa fa-lock"></i>
                                                                Country
                ...
                <div class="modal-content premium-modal" style="max-width: 650px; margin: 0 auto;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="border rounded p-3"
                            style="white-space: pre-wrap; max-height: 320px; overflow:auto;" id="tokenAgreeModalBody">
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content premium-modal" style="max-width: 500px; margin: 0 auto;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-4" id="billing-period-group">
                            <label style="font-weight: 600; color: #555; margin-bottom: 10px; display: block;">Billing Period</label>
                            <div class="sp-billing-options" id="registerBillingPeriodToggle">
                                <label class="sp-billing-option">
                                    ...
                                    <span class="sp-billing-card">
                                        ...
                                        <span class="sp-billing-text">
                                            ...
                                            <span class="sp-billing-price" id="reg-monthly-label">$0/mo</span>
                                        </span>
                                    </span>
                                </label>
                                <label class="sp-billing-option">
                                    ...
                                    <span class="sp-billing-card">
                                        ...
                                        <span class="sp-billing-text">
                                            ...
                                            <span class="sp-billing-price" id="reg-yearly-label">$0/yr</span>
                                        </span>
                                    </span>
                                </label>
                            </div>
                        ...
                        <form id="payment-form">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div style="display: flex; gap: 10px; align-items: stretch;">
                                    ...
                                    <button type="button" id="validate-promo-btn" class="btn sp-apply-btn"
                                        style="padding: 0 20px; border-radius: 6px; white-space: nowrap;"
                                        disabled>
                                        Apply
                                    </button>
                                </div>
        ...
        <script>
            $(document).ready(function() {
                        ...
                        success: function(response) {
                            ...
                            if (response.status === true) {
                                ...
                                if ($('#tier_id').length === 0) {
                                    ...
                                    // If user selected an Ecclesia - highlight Tier 2, otherwise - highlight Tier 1
                                    var ecclessia_id = formData.get('ecclesia_id');
                                    if (ecclessia_id != '') {
                                        // Ecclesia selected: recommend Tier 2 (index 1)
                                        $('#featured_0').removeClass('featured');
                                        $('#featured_1').addClass('featured');
                                    } else {
                                        // No Ecclesia: recommend Tier 1 (index 0)
                ...
                $('.select-tier-btn').off('click').on('click', function() {
                    ...
                    originalAmount = currentYearlyCost;
                    cost = originalAmount;
