...
@section('title')
    Update Becoming Sovereigns - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
@section('content')
<section id="loading">
    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('becoming-sovereign.update', $file->id) }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                        @csrf
                        <input type="hidden" name="new_topic" value="{{$new_topic ?? ''}}">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading_box mb-5">
                                    <h3>Update Becoming Sovereigns</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="w-100 text-end d-flex align-items-center justify-content-end mt-3">
                                ...
                                <a href="{{ route('becoming-sovereign.index') . '?topic=' . ($new_topic ?? '') }}" class="print_btn print_btn_vv"
                                    >Cancel</a>
                            </div>
                        </div>
                </div>
