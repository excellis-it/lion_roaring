...
@section('content')
    ...
    <div class="container-fluid">
        <div class="bg_white_border">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('becoming-sovereign.update', $file->id) }}" method="POST"
                        ...
                        <div class="row">
                                    ...
                                    <select name="topic_id" id="topics" class="form-control">
                                        ...
                                        @foreach ($topics as $topic)
                                            <option value="{{ $topic->id }}"
                                                {{ $file->topic_id == $topic->id ? 'selected' : '' }}>
                            ...
                            <div class="w-100 text-end d-flex align-items-center justify-content-end mt-3">
                                ...
                                <a href="{{ route('becoming-sovereign.index') . '?topic=' . ($new_topic ?? '') }}"
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#countries').on('change', function() {
                    ...
                    var education_type = 'Becoming Sovereign';
                    if (country_id) {
                        $.ajax({
