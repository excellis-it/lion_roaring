                                    ...
                                    @if ($file->file_extension == 'pdf')
                                        ...
                                        (function () {
                                            ...
                                            loadingTask.promise.then(function (pdf) {
                                                ...
                                                overlay.innerHTML =
                                                    '<p class="text-danger p-4">Failed to load PDF. ' +
                                                    '<a href="' + pdfUrl + '" target="_blank" rel="noopener">Open in new tab</a></p>';
                                            });
