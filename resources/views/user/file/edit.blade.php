                                ...
                                <div class="box_label">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        ...
                                        <option value="Becoming Christ Like"
                                            {{ $file->type == 'Becoming Christ Like' ? 'selected' : '' }}>Becoming Christ
                                            Like
                                        </option>
                                        <option value="Becoming a Leader"
                                            {{ $file->type == 'Becoming a Leader' ? 'selected' : '' }}>Becoming a Leader
                                        </option>
                                    </select>
                                    @if ($errors->has('type'))
                        ...
                        success: function(resp) {
                            ...
                            $.each(resp.data, function(index, value) {
                                if (oldTopic == value.id) {
                                    ...
                                    html += '<option value="' + value.id + '">' + value.topic_name +
                                        '</option>';
                                }
                            });
                            $('#topics').html(html);
