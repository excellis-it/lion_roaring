...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('elearning_assets/bootstrap-5.3.2/css/bootstrap.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css"
        href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.css" />
    <link rel="stylesheet" type="text/css"
        href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.2.3/animate.min.css" />
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <link href="{{ asset('elearning_assets/css/menu.css') }}" rel="stylesheet" />
    <link href="{{ asset('elearning_assets/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('elearning_assets/css/responsive.css') }}" rel="stylesheet">
...
<body class="loading">
    ...
    <script src="{{ asset('elearning_assets/bootstrap-5.3.2/js/bootstrap.bundle.min.js') }}"></script>
    <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
    <script src="{{ asset('elearning_assets/js/custom.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
    @include('frontend.includes.toastr_flash', ['toastrPositionClass' => 'toast-top-right'])
    <script>
